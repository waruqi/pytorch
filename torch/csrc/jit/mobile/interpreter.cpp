...
bool InterpreterState::run(Stack& stack) {
  while (true) {
    try {
      ...
      // NOTE: this recordFunction logic takes up ~2-3% of cpu cycles in stella
      // during g2p inference. do we need it and/or can we opt-out of
      // isRecordFunctionEnabled with a macro? if we delete it, g2p appears to
